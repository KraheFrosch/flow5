...
namespace {
struct qt_meta_tag_ZN12FoilPolarDlgE_t {};
} // unnamed namespace

template <> constexpr inline auto FoilPolarDlg::qt_create_metaobjectdata<qt_meta_tag_ZN12FoilPolarDlgE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<FoilPolarDlg, qt_meta_tag_ZN12FoilPolarDlgE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject FoilPolarDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<XflDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12FoilPolarDlgE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12FoilPolarDlgE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12FoilPolarDlgE_t>.metaTypes,
    nullptr
} };
...
void *FoilPolarDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12FoilPolarDlgE_t>.strings))

...
namespace {
struct qt_meta_tag_ZN14Foil2SplineDlgE_t {};
} // unnamed namespace

template <> constexpr inline auto Foil2SplineDlg::qt_create_metaobjectdata<qt_meta_tag_ZN14Foil2SplineDlgE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Foil2SplineDlg, qt_meta_tag_ZN14Foil2SplineDlgE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Foil2SplineDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<FoilDlg::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14Foil2SplineDlgE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14Foil2SplineDlgE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14Foil2SplineDlgE_t>.metaTypes,
    nullptr
} };
...
void *Foil2SplineDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14Foil2SplineDlgE_t>.strings))

...
namespace {
struct qt_meta_tag_ZN14Fine3dControlsE_t {};
} // unnamed namespace

template <> constexpr inline auto Fine3dControls::qt_create_metaobjectdata<qt_meta_tag_ZN14Fine3dControlsE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Fine3dControls, qt_meta_tag_ZN14Fine3dControlsE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Fine3dControls::staticMetaObject = { {
    QMetaObject::SuperData::link<QFrame::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14Fine3dControlsE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14Fine3dControlsE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14Fine3dControlsE_t>.metaTypes,
    nullptr
} };
...
void *Fine3dControls::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14Fine3dControlsE_t>.strings))

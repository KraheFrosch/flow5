...
namespace {
struct qt_meta_tag_ZN12CpGraphCtrlsE_t {};
} // unnamed namespace

template <> constexpr inline auto CpGraphCtrls::qt_create_metaobjectdata<qt_meta_tag_ZN12CpGraphCtrlsE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<CpGraphCtrls, qt_meta_tag_ZN12CpGraphCtrlsE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject CpGraphCtrls::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12CpGraphCtrlsE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12CpGraphCtrlsE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12CpGraphCtrlsE_t>.metaTypes,
    nullptr
} };
...
void *CpGraphCtrls::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12CpGraphCtrlsE_t>.strings))

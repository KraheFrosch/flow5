...
namespace {
struct qt_meta_tag_ZN6FoilWtE_t {};
} // unnamed namespace

template <> constexpr inline auto FoilWt::qt_create_metaobjectdata<qt_meta_tag_ZN6FoilWtE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<FoilWt, qt_meta_tag_ZN6FoilWtE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject FoilWt::staticMetaObject = { {
    QMetaObject::SuperData::link<Section2dWt::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6FoilWtE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6FoilWtE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN6FoilWtE_t>.metaTypes,
    nullptr
} };
...
void *FoilWt::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6FoilWtE_t>.strings))

...
namespace {
struct qt_meta_tag_ZN16FormatTextOutputE_t {};
} // unnamed namespace

template <> constexpr inline auto FormatTextOutput::qt_create_metaobjectdata<qt_meta_tag_ZN16FormatTextOutputE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'onAppendStdText'
        QtMocHelpers::SlotData<void(std::string const &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'onAppendQText'
    ...
    return QtMocHelpers::metaObjectData<FormatTextOutput, qt_meta_tag_ZN16FormatTextOutputE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject FormatTextOutput::staticMetaObject = { {
    QMetaObject::SuperData::link<QTextEdit::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16FormatTextOutputE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16FormatTextOutputE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN16FormatTextOutputE_t>.metaTypes,
    nullptr
} };
...
void *FormatTextOutput::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16FormatTextOutputE_t>.strings))

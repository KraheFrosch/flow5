...
namespace {
struct qt_meta_tag_ZN10T6PolarDlgE_t {};
} // unnamed namespace

template <> constexpr inline auto T6PolarDlg::qt_create_metaobjectdata<qt_meta_tag_ZN10T6PolarDlgE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onAdjustedVelocity'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onRangeCellChanged'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onInertiaCellChanged'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onAngleCellChanged'
    ...
    return QtMocHelpers::metaObjectData<T6PolarDlg, qt_meta_tag_ZN10T6PolarDlgE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject T6PolarDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<PlanePolarDlg::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10T6PolarDlgE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10T6PolarDlgE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10T6PolarDlgE_t>.metaTypes,
    nullptr
} };
...
void *T6PolarDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10T6PolarDlgE_t>.strings))

...
namespace {
struct qt_meta_tag_ZN10gl3dShadowE_t {};
} // unnamed namespace

template <> constexpr inline auto gl3dShadow::qt_create_metaobjectdata<qt_meta_tag_ZN10gl3dShadowE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<gl3dShadow, qt_meta_tag_ZN10gl3dShadowE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject gl3dShadow::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10gl3dShadowE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10gl3dShadowE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10gl3dShadowE_t>.metaTypes,
    nullptr
} };
...
void *gl3dShadow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10gl3dShadowE_t>.strings))

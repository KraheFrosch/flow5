...
namespace {
struct qt_meta_tag_ZN13WingObjectDlgE_t {};
} // unnamed namespace

template <> constexpr inline auto WingObjectDlg::qt_create_metaobjectdata<qt_meta_tag_ZN13WingObjectDlgE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<WingObjectDlg, qt_meta_tag_ZN13WingObjectDlgE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject WingObjectDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<WingDlg::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13WingObjectDlgE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13WingObjectDlgE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13WingObjectDlgE_t>.metaTypes,
    nullptr
} };
...
void *WingObjectDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13WingObjectDlgE_t>.strings))

...
namespace {
struct qt_meta_tag_ZN14gl3dAttractorsE_t {};
} // unnamed namespace

template <> constexpr inline auto gl3dAttractors::qt_create_metaobjectdata<qt_meta_tag_ZN14gl3dAttractorsE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<gl3dAttractors, qt_meta_tag_ZN14gl3dAttractorsE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject gl3dAttractors::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14gl3dAttractorsE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14gl3dAttractorsE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14gl3dAttractorsE_t>.metaTypes,
    nullptr
} };
...
void *gl3dAttractors::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14gl3dAttractorsE_t>.strings))

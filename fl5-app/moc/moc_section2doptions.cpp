...
namespace {
struct qt_meta_tag_ZN16Section2dOptionsE_t {};
} // unnamed namespace

template <> constexpr inline auto Section2dOptions::qt_create_metaobjectdata<qt_meta_tag_ZN16Section2dOptionsE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onHighStyle'
        QtMocHelpers::SlotData<void(LineStyle)>(5, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Slot 'onSelStyle'
        QtMocHelpers::SlotData<void(LineStyle)>(8, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
    ...
    return QtMocHelpers::metaObjectData<Section2dOptions, qt_meta_tag_ZN16Section2dOptionsE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Section2dOptions::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16Section2dOptionsE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16Section2dOptionsE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN16Section2dOptionsE_t>.metaTypes,
    nullptr
} };
...
void *Section2dOptions::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16Section2dOptionsE_t>.strings))

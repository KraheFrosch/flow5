...
namespace {
struct qt_meta_tag_ZN15BoatAnalysisDlgE_t {};
} // unnamed namespace

template <> constexpr inline auto BoatAnalysisDlg::qt_create_metaobjectdata<qt_meta_tag_ZN15BoatAnalysisDlgE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(std::string const &)>(8, 2, QMC::AccessProtected, QMetaType::Void, {{
            { 0x80000000 | 9, 10 },
        }}),
        // Slot 'onOutputMessage'
        QtMocHelpers::SlotData<void(QString const &)>(11, 2, QMC::AccessProtected, QMetaType::Void, {{
    ...
    return QtMocHelpers::metaObjectData<BoatAnalysisDlg, qt_meta_tag_ZN15BoatAnalysisDlgE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject BoatAnalysisDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15BoatAnalysisDlgE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15BoatAnalysisDlgE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15BoatAnalysisDlgE_t>.metaTypes,
    nullptr
} };
...
void BoatAnalysisDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (BoatAnalysisDlg::*)()>(_a, &BoatAnalysisDlg::analysisFinished, 0))
            return;
    }
}
...
void *BoatAnalysisDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15BoatAnalysisDlgE_t>.strings))

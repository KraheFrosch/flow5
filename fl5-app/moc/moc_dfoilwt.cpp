...
namespace {
struct qt_meta_tag_ZN7DFoilWtE_t {};
} // unnamed namespace

template <> constexpr inline auto DFoilWt::qt_create_metaobjectdata<qt_meta_tag_ZN7DFoilWtE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'foilSelected'
        QtMocHelpers::SignalData<void(Foil *)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 2 },
        }}),
        // Slot 'onHovered'
    ...
    return QtMocHelpers::metaObjectData<DFoilWt, qt_meta_tag_ZN7DFoilWtE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject DFoilWt::staticMetaObject = { {
    QMetaObject::SuperData::link<Section2dWt::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7DFoilWtE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7DFoilWtE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7DFoilWtE_t>.metaTypes,
    nullptr
} };
...
void DFoilWt::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DFoilWt::*)(Foil * )>(_a, &DFoilWt::foilSelected, 0))
            return;
    }
}
...
void *DFoilWt::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7DFoilWtE_t>.strings))

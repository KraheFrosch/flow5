...
namespace {
struct qt_meta_tag_ZN11AeroDataDlgE_t {};
} // unnamed namespace

template <> constexpr inline auto AeroDataDlg::qt_create_metaobjectdata<qt_meta_tag_ZN11AeroDataDlgE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<AeroDataDlg, qt_meta_tag_ZN11AeroDataDlgE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject AeroDataDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11AeroDataDlgE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11AeroDataDlgE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11AeroDataDlgE_t>.metaTypes,
    nullptr
} };
...
void *AeroDataDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11AeroDataDlgE_t>.strings))

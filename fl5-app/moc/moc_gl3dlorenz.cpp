...
namespace {
struct qt_meta_tag_ZN10gl3dLorenzE_t {};
} // unnamed namespace

template <> constexpr inline auto gl3dLorenz::qt_create_metaobjectdata<qt_meta_tag_ZN10gl3dLorenzE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<gl3dLorenz, qt_meta_tag_ZN10gl3dLorenzE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject gl3dLorenz::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10gl3dLorenzE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10gl3dLorenzE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10gl3dLorenzE_t>.metaTypes,
    nullptr
} };
...
void *gl3dLorenz::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10gl3dLorenzE_t>.strings))

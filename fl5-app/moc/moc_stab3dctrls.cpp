...
namespace {
struct qt_meta_tag_ZN11Stab3dCtrlsE_t {};
} // unnamed namespace

template <> constexpr inline auto Stab3dCtrls::qt_create_metaobjectdata<qt_meta_tag_ZN11Stab3dCtrlsE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onAnimateRestart'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onAnimationAmplitude'
    ...
    return QtMocHelpers::metaObjectData<Stab3dCtrls, qt_meta_tag_ZN11Stab3dCtrlsE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Stab3dCtrls::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11Stab3dCtrlsE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11Stab3dCtrlsE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11Stab3dCtrlsE_t>.metaTypes,
    nullptr
} };
...
void *Stab3dCtrls::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11Stab3dCtrlsE_t>.strings))

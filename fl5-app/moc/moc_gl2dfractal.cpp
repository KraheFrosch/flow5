...
namespace {
struct qt_meta_tag_ZN11gl2dFractalE_t {};
} // unnamed namespace

template <> constexpr inline auto gl2dFractal::qt_create_metaobjectdata<qt_meta_tag_ZN11gl2dFractalE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<gl2dFractal, qt_meta_tag_ZN11gl2dFractalE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject gl2dFractal::staticMetaObject = { {
    QMetaObject::SuperData::link<gl2dView::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11gl2dFractalE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11gl2dFractalE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11gl2dFractalE_t>.metaTypes,
    nullptr
} };
...
void *gl2dFractal::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11gl2dFractalE_t>.strings))

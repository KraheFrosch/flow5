...
namespace {
struct qt_meta_tag_ZN12SailScaleDlgE_t {};
} // unnamed namespace

template <> constexpr inline auto SailScaleDlg::qt_create_metaobjectdata<qt_meta_tag_ZN12SailScaleDlgE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<SailScaleDlg, qt_meta_tag_ZN12SailScaleDlgE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject SailScaleDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12SailScaleDlgE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12SailScaleDlgE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12SailScaleDlgE_t>.metaTypes,
    nullptr
} };
...
void *SailScaleDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12SailScaleDlgE_t>.strings))

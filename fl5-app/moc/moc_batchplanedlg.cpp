...
namespace {
struct qt_meta_tag_ZN13BatchPlaneDlgE_t {};
} // unnamed namespace

template <> constexpr inline auto BatchPlaneDlg::qt_create_metaobjectdata<qt_meta_tag_ZN13BatchPlaneDlgE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(QModelIndex, QModelIndex)>(6, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 7, 8 }, { 0x80000000 | 7, 2 },
        }}),
        // Slot 'onEditAnalysis'
        QtMocHelpers::SlotData<void()>(9, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onMessage'
        QtMocHelpers::SlotData<void(QString const &)>(10, 2, QMC::AccessPrivate, QMetaType::Void, {{
    ...
    return QtMocHelpers::metaObjectData<BatchPlaneDlg, qt_meta_tag_ZN13BatchPlaneDlgE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject BatchPlaneDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13BatchPlaneDlgE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13BatchPlaneDlgE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13BatchPlaneDlgE_t>.metaTypes,
    nullptr
} };
...
void *BatchPlaneDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13BatchPlaneDlgE_t>.strings))

...
namespace {
struct qt_meta_tag_ZN13Panel3TestDlgE_t {};
} // unnamed namespace

template <> constexpr inline auto Panel3TestDlg::qt_create_metaobjectdata<qt_meta_tag_ZN13Panel3TestDlgE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Panel3TestDlg, qt_meta_tag_ZN13Panel3TestDlgE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Panel3TestDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13Panel3TestDlgE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13Panel3TestDlgE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13Panel3TestDlgE_t>.metaTypes,
    nullptr
} };
...
void *Panel3TestDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13Panel3TestDlgE_t>.strings))

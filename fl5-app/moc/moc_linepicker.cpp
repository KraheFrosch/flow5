...
namespace {
struct qt_meta_tag_ZN10LinePickerE_t {};
} // unnamed namespace

template <> constexpr inline auto LinePicker::qt_create_metaobjectdata<qt_meta_tag_ZN10LinePickerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onClickedLB'
        QtMocHelpers::SlotData<void(LineStyle)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 4, 5 },
        }}),
        // Slot 'onOtherColor'
    ...
    return QtMocHelpers::metaObjectData<LinePicker, qt_meta_tag_ZN10LinePickerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject LinePicker::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10LinePickerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10LinePickerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10LinePickerE_t>.metaTypes,
    nullptr
} };
...
void LinePicker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LinePicker::*)(QColor )>(_a, &LinePicker::colorChanged, 0))
            return;
    }
}
...
void *LinePicker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10LinePickerE_t>.strings))

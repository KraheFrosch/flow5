...
namespace {
struct qt_meta_tag_ZN15PlainTextOutputE_t {};
} // unnamed namespace

template <> constexpr inline auto PlainTextOutput::qt_create_metaobjectdata<qt_meta_tag_ZN15PlainTextOutputE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<PlainTextOutput, qt_meta_tag_ZN15PlainTextOutputE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject PlainTextOutput::staticMetaObject = { {
    QMetaObject::SuperData::link<QPlainTextEdit::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15PlainTextOutputE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15PlainTextOutputE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15PlainTextOutputE_t>.metaTypes,
    nullptr
} };
...
void *PlainTextOutput::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15PlainTextOutputE_t>.strings))

...
namespace {
struct qt_meta_tag_ZN8CpViewWtE_t {};
} // unnamed namespace

template <> constexpr inline auto CpViewWt::qt_create_metaobjectdata<qt_meta_tag_ZN8CpViewWtE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<CpViewWt, qt_meta_tag_ZN8CpViewWtE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject CpViewWt::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8CpViewWtE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8CpViewWtE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN8CpViewWtE_t>.metaTypes,
    nullptr
} };
...
void *CpViewWt::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8CpViewWtE_t>.strings))

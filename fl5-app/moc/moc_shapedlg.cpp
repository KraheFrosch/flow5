...
namespace {
struct qt_meta_tag_ZN8ShapeDlgE_t {};
} // unnamed namespace

template <> constexpr inline auto ShapeDlg::qt_create_metaobjectdata<qt_meta_tag_ZN8ShapeDlgE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<ShapeDlg, qt_meta_tag_ZN8ShapeDlgE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject ShapeDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8ShapeDlgE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8ShapeDlgE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN8ShapeDlgE_t>.metaTypes,
    nullptr
} };
...
void *ShapeDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8ShapeDlgE_t>.strings))

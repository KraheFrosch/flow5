...
namespace {
struct qt_meta_tag_ZN15gl3dSingularityE_t {};
} // unnamed namespace

template <> constexpr inline auto gl3dSingularity::qt_create_metaobjectdata<qt_meta_tag_ZN15gl3dSingularityE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<gl3dSingularity, qt_meta_tag_ZN15gl3dSingularityE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject gl3dSingularity::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15gl3dSingularityE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15gl3dSingularityE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15gl3dSingularityE_t>.metaTypes,
    nullptr
} };
...
void *gl3dSingularity::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15gl3dSingularityE_t>.strings))

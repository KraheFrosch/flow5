...
namespace {
struct qt_meta_tag_ZN10gl2dNewtonE_t {};
} // unnamed namespace

template <> constexpr inline auto gl2dNewton::qt_create_metaobjectdata<qt_meta_tag_ZN10gl2dNewtonE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<gl2dNewton, qt_meta_tag_ZN10gl2dNewtonE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject gl2dNewton::staticMetaObject = { {
    QMetaObject::SuperData::link<gl2dView::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10gl2dNewtonE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10gl2dNewtonE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10gl2dNewtonE_t>.metaTypes,
    nullptr
} };
...
void *gl2dNewton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10gl2dNewtonE_t>.strings))

...
namespace {
struct qt_meta_tag_ZN9XflDialogE_t {};
} // unnamed namespace

template <> constexpr inline auto XflDialog::qt_create_metaobjectdata<qt_meta_tag_ZN9XflDialogE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'keyPressEvent'
        QtMocHelpers::SlotData<void(QKeyEvent *)>(3, 2, QMC::AccessProtected, QMetaType::Void, {{
            { 0x80000000 | 4, 5 },
        }}),
        // Slot 'onButton'
    ...
    return QtMocHelpers::metaObjectData<XflDialog, qt_meta_tag_ZN9XflDialogE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject XflDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9XflDialogE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9XflDialogE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN9XflDialogE_t>.metaTypes,
    nullptr
} };
...
void *XflDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9XflDialogE_t>.strings))

...
namespace {
struct qt_meta_tag_ZN9FoilTableE_t {};
} // unnamed namespace

template <> constexpr inline auto FoilTable::qt_create_metaobjectdata<qt_meta_tag_ZN9FoilTableE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'selectFoil'
        QtMocHelpers::SlotData<void(Foil *)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 8, 9 },
        }}),
    };
    ...
    return QtMocHelpers::metaObjectData<FoilTable, qt_meta_tag_ZN9FoilTableE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject FoilTable::staticMetaObject = { {
    QMetaObject::SuperData::link<CPTableView::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9FoilTableE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9FoilTableE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN9FoilTableE_t>.metaTypes,
    nullptr
} };
...
void *FoilTable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9FoilTableE_t>.strings))

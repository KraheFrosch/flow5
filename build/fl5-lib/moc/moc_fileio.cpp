...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_FileIO_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_FileIO_t qt_meta_stringdata_FileIO = {
    {
        QT_MOC_LITERAL(0, 6),  // "FileIO"
        QT_MOC_LITERAL(7, 10),  // "fileLoaded"
        QT_MOC_LITERAL(18, 0),  // ""
        QT_MOC_LITERAL(19, 6),  // "bError"
        QT_MOC_LITERAL(26, 14),  // "displayMessage"
        QT_MOC_LITERAL(41, 3),  // "msg"
        QT_MOC_LITERAL(45, 13),  // "onLoadProject"
...
Q_CONSTINIT static const uint qt_meta_data_FileIO[] = {
...
Q_CONSTINIT const QMetaObject FileIO::staticMetaObject = { {
    ...
    qt_meta_stringdata_FileIO.offsetsAndSizes,
    qt_meta_data_FileIO,
    qt_static_metacall,
    nullptr,
...
void FileIO::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FileIO::*)(bool );
            if (_t _q_method = &FileIO::fileLoaded; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FileIO::*)(QString const & );
            if (_t _q_method = &FileIO::displayMessage; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }

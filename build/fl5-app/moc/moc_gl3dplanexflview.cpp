...
#include <memory>
#include "../../../fl5-app/interfaces/opengl/fl5views/gl3dplanexflview.h"
...
namespace {
struct qt_meta_stringdata_gl3dPlaneXflView_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_gl3dPlaneXflView_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_gl3dPlaneXflView_t qt_meta_stringdata_gl3dPlaneXflView = {
    {
        QT_MOC_LITERAL(0, 16),  // "gl3dPlaneXflView"
        QT_MOC_LITERAL(17, 16),  // "onPartSelClicked"
        QT_MOC_LITERAL(34, 0)   // ""
    },
    "gl3dPlaneXflView",
    "onPartSelClicked",
...
Q_CONSTINIT static const uint qt_meta_data_gl3dPlaneXflView[] = {
...
Q_CONSTINIT const QMetaObject gl3dPlaneXflView::staticMetaObject = { {
    ...
    qt_meta_stringdata_gl3dPlaneXflView.offsetsAndSizes,
    qt_meta_data_gl3dPlaneXflView,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_gl3dPlaneXflView_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<gl3dPlaneXflView, std::true_type>,
...
void *gl3dPlaneXflView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_gl3dPlaneXflView.stringdata0))
